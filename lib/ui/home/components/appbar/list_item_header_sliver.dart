      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width:3),
            categoryFunctionButton('SummaryFun_1'.tr, 0xFFFFF6CB,0xFFC38100,0),
            SizedBox(width: 4),
            categoryFunctionButton('SummaryFun_2'.tr, 0xFFFAE1FF,0xFF9B3AAB,1),
            SizedBox(width: 4),
            categoryFunctionButton('SummaryFun_3'.tr, 0xFFD3ECFF,0xFF29B3FF,2),
            SizedBox(width: 12),
