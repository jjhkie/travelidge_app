      ...
      Padding(
        ...
        child: SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              allGenreButton('ContentGen'.tr, 0xFFD3D3D3, 0xFF000000),
              const SizedBox(width: 10),
              categoryGenreButton('ContentGen_1'.tr, 0xFFD3D3D3, 0xFF000000, 0),
              const SizedBox(width: 10),
              categoryGenreButton('ContentGen_2'.tr, 0xFFD3D3D3, 0xFF000000, 1),
              const SizedBox(width: 10),
              categoryGenreButton('ContentGen_3'.tr, 0xFFD3D3D3, 0xFF000000, 2),
              const SizedBox(width: 10),
              categoryGenreButton('ContentGen_4'.tr, 0xFFD3D3D3, 0xFF000000, 3),
              const SizedBox(width: 10),
              categoryGenreButton('ContentGen_5'.tr, 0xFFD3D3D3, 0xFF000000, 4),
              const SizedBox(width: 10),
              categoryGenreButton('ContentGen_6'.tr, 0xFFD3D3D3, 0xFF000000, 5),
              const SizedBox(width: 10)
            ],
          ),
        ),
