              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      child: Row(
                        children: [
                          roundElevatedButton('pro_modify',Colors.transparent, Colors.grey.withOpacity(0.6), Colors.black),
                          SizedBox(width: 5),
                          roundElevatedButton('fri_management',Colors.transparent, Colors.grey.withOpacity(0.6), Colors.black),
                        ],
                      )),
                  ...
                  Container(
                    child: TabBar(
                      ...
                      tabs: [
                        Container(
                          child: Text('photo_album'.tr,style:TextStyle(color: Palette.black)),
                        ),
                        Container(
                          child: Text('tourList'.tr,style:TextStyle(color: Palette.black)),
                        ),
                        Container(
                          child: Text('wishList'.tr,style:TextStyle(color: Palette.black)),
                        ),
                      ],
                    ),
                  )
